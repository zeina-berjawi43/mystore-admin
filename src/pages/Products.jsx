...
function Products() {
  ...
  const fetchProducts = async (showInitialLoading = false) => {
    try {
      ...
      // cache-buster - same reasoning as Orders/Dashboard/Users:
      // guarantees this never comes back as a stale cached response.
  ...
  return (
    <div className="products-page">
      <div className="products-header">
        <div>
          <h1>Products</h1>
          <p>Manage your products, prices and discounts.</p>
        </div>
