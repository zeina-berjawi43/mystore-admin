...
function Slideshow() {
  ...
  const fetchSlides = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Failed to load slideshow"
        );
      }
      ...
      setError(
        error.message || "Failed to load slideshow"
      );
    } finally {
      setLoading(false);
    }
  ...
  const uploadImage = async () => {
    ...
    // "slideshow" is mapped server-side to the Supabase bucket
    // "slideshow-images".
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      let imagePath = editingSlide ? editingSlide.image : "";
      ...
      if (editingSlide) {
        ...
        response = await fetch(`${API_URL}/slideshows`, {
          method: "POST",
          headers: getHeaders(),
          body: JSON.stringify(body),
        });
  ...
  const toggleActive = async (slide) => {
    try {
      ...
      alert(error.message || "Error updating slide");
    }
  };
  ...
  return (
    <div className="slideshow-page">
      <div className="slideshow-header">
        <div>
          <h1>Slideshow</h1>
          <p>Manage the images displayed on the Home page.</p>
        </div>
      ...
      {error && (
        <div className="slideshow-error">
          ...
          <button type="button" onClick={fetchSlides}>
            Try Again
          </button>
        </div>
      )}
      ...
      {slides.length === 0 ? (
        <div className="slideshow-empty">
          <div className="empty-slide-icon">🖼️</div>

          <h3>No slideshow images</h3>
          <p>Add images to display them on the Home page.</p>
        ...
        <div className="slideshow-grid">
          {slides.map((slide) => {
            const finalImageUrl = getImageUrl(slide.image || "");
              ...
              <div className="slide-card" key={slide._id}>
                ...
                <div className="slide-card-content">
                  <div className="slide-info">
                    ...
                    <strong
                      className={
                        slide.active ? "active-text" : "inactive-text"
                      }
                    >
          ...
          <div className="slide-modal">
            <div className="slide-modal-header">
              <div>
                ...
                <p>Choose an image for the Home slideshow.</p>
              </div>
            ...
            <form className="slide-form" onSubmit={handleSubmit}>
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className="slide-upload-placeholder">
                      <div className="slide-upload-icon">📷</div>
              ...
              <label className="slide-active-row">
                ...
                <span>Show this image in the slideshow</span>
              </label>
